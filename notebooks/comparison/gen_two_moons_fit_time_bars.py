"""
Generates the Two Moons total-training-time bar charts used in the report's
results section: 5seed_two_moons_bayesian_total_time_bar.png and
5seed_two_moons_laplace_total_time_bar.png, from the 5-seed metrics CSVs.
...
plot_total_time_bar(bt_df, bt_means, "Two Moons Bayesian — Total Time (mean, 5 seeds)",
                     "5seed_two_moons_bayesian_total_time_bar.png", ylim)
plot_total_time_bar(la_df, la_means, "Two Moons Laplace — Total Time (mean, 5 seeds)",
                     "5seed_two_moons_laplace_total_time_bar.png", ylim)
print("Done.")
