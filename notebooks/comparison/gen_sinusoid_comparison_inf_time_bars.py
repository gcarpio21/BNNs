"""
Generates the Sinusoid comparison-dataset (big/second set) inference-time
bar charts used in the report's results section:
5seed_sinusoid_comparison_bayesian_inf_time_bar.png and
5seed_sinusoid_comparison_laplace_inf_time_bar.png, from the comparison
...
plot_inf_time_bar(bt_df, "Sinusoid Comparison Bayesian — Inference Time (mean ± std, 5 seeds)",
                   "5seed_sinusoid_comparison_bayesian_inf_time_bar.png", ylim)
plot_inf_time_bar(la_df, "Sinusoid Comparison Laplace — Inference Time (mean ± std, 5 seeds)",
                   "5seed_sinusoid_comparison_laplace_inf_time_bar.png", ylim)
print("Done.")
