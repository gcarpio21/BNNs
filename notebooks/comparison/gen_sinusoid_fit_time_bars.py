"""
Generates the Sinusoid (small dataset) total-training-time bar charts used
in the report's Appendix: 5seed_sinusoid_bayesian_total_time_bar.png and
5seed_sinusoid_laplace_total_time_bar.png, from the 5-seed metrics CSVs.
...
BT_CSV = ROOT / "notebooks" / "bayesian" / "results" / "metrics" / "sinusoid_bayesian_5seed_metrics.csv"
LA_CSV = ROOT / "notebooks" / "laplace"  / "results" / "metrics" / "sinusoid_laplace_5seed_metrics.csv"
...
plot_total_time_bar(bt_df, bt_means, "Sinusoid Bayesian — Total Time (mean, 5 seeds)",
                     "5seed_sinusoid_bayesian_total_time_bar.png", ylim)
plot_total_time_bar(la_df, la_means, "Sinusoid Laplace — Total Time (mean, 5 seeds)",
                     "5seed_sinusoid_laplace_total_time_bar.png", ylim)
print("Done.")
