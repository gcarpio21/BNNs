"""
Generates the Sinusoid (small dataset) inference-time bar charts used in
the report's Appendix: 5seed_sinusoid_bayesian_inf_time_bar.png and
5seed_sinusoid_laplace_inf_time_bar.png, from the 5-seed metrics CSVs.
...
plot_inf_time_bar(bt_df, "Sinusoid Bayesian — Inference Time (mean ± std, 5 seeds)",
                   "5seed_sinusoid_bayesian_inf_time_bar.png", ylim)
plot_inf_time_bar(la_df, "Sinusoid Laplace — Inference Time (mean ± std, 5 seeds)",
                   "5seed_sinusoid_laplace_inf_time_bar.png", ylim)
print("Done.")
