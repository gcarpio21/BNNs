...
\textbf{Bayesian Neural Networks (BNNs)~\citep{goan2020bayesian,murphy2023pml}.} In Bayesian Deep Learning, Given $\cD = \{(\bm{x}_n, y_n)\}
_{n=1}^{N}$ and network $f_{\btheta}$, the posterior is $p(\btheta \mid \cD) = p(\cD|\btheta)\,p(\btheta)/p(\cD)$. 
